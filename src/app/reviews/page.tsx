            ...
            <figure key={t.name} className="card flex flex-col p-6">
              <div className="flex items-center justify-between">
                ...
                <span className="inline-flex items-center gap-1 rounded-full bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M9 16.2l-3.5-3.5L4 14.2 9 19l11-11-1.4-1.4z" /></svg>
                  Verified
                </span>
              </div>
              ...
              <figcaption className="mt-4 text-sm font-semibold text-navy-900">
                {t.name} <span className="font-normal text-navy-400">· {t.location}</span>
              </figcaption>
            </figure>
          ))}
        </div>
