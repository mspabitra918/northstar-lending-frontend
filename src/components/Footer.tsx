      ...
      <div className="container-x grid gap-10 py-14 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-3 max-w-sm text-sm leading-relaxed text-navy-300">
            ...
            {formatUSD(LOAN.maxAmount)} at a fixed {LOAN.apr}% APR. No collateral,
            no upfront fees, funded within {LOAN.fundingHours} hours.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-navy-300">
            ...
            <li><Link className="hover:text-white" href="/reviews">Reviews & Trust</Link></li>
            <li><Link className="hover:text-white" href="/status">Loan Status</Link></li>
            <li><Link className="hover:text-white" href="/apply">Apply Now</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm text-navy-300">
            <li>{BRAND.address.city}, {BRAND.address.region}</li>
